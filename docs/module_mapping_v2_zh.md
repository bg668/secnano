...
> **注**：本文件是 [`module_mapping_v2.md`](./module_mapping_v2.md) 的中文译本，内容保持同步。

## 1. 文档目的

本文档将 `main` 实现中的每个当前文件区域和模块映射到 `architecture_v2.md` 中定义的具体 V2 架构目标。
...
| `docs/module_boundary_checklist.md` | 原十二模块架构规范 | `architecture_v2.md` 在 V2 中取代本文档；在 `main` 中作为历史参考保留 | `KEEP AS REF` |
| `docs/development_milestones.md` | M0–M4 里程碑 | `migration_plan_v2.md` 定义 V2 阶段；旧里程碑仅适用于 `main` | `KEEP AS REF` |
| `docs/project_progress.md` | 当前完成状态 | V2 有自己的进展追踪；在 `main` 中保留旧追踪器 | `KEEP AS REF` |
| `docs/architecture_v2.md` | **V2 架构参考** | 本分支 V2 的规范架构文档 | **新建（本分支）** |
| `docs/module_mapping_v2.md` | **V2 模块映射** | 本文档 | **新建（本分支）** |
| `docs/migration_plan_v2.md` | **V2 迁移计划** | V2 分阶段实施路线图 | **新建（本分支）** |
