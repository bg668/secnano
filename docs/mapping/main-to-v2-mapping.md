...
This document maps every current file area and module in the `main` implementation to a specific V2 architecture destination (defined in `../architecture/en/architecture-overview.md`).
...
| `docs/module_boundary_checklist.md` | Original 12-module architecture spec | `docs/architecture/en/architecture-overview.md` supersedes this for V2; keep in `main` as historical ref | `KEEP AS REF` |
| `docs/development_milestones.md` | M0–M4 milestones | `docs/plan/roadmap.md` defines V2 phases; old milestones apply to `main` only | `KEEP AS REF` |
...
| `docs/architecture/en/architecture-overview.md` | **V2 architecture reference** | This is the V2 canonical architecture doc | **NEW (this branch)** |
| `docs/mapping/main-to-v2-mapping.md` | **V2 module mapping** | This document | **NEW (this branch)** |
| `docs/plan/roadmap.md` | **V2 migration plan** | V2 phased implementation roadmap | **NEW (this branch)** |
...
When beginning V2 implementation (see also `../plan/roadmap.md`):
